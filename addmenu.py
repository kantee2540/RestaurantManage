...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(20, 80, 351, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.comboBox.setGeometry(QtCore.QRect(20, 140, 351, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "บุฟเฟ่"))
        self.comboBox.setItemText(1, _translate("Dialog", "อาหารจานเดี่ยว"))
